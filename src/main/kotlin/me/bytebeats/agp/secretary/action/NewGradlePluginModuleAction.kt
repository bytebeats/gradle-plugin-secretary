...
open class NewGradlePluginModuleAction(
    text: String = getString(NEW_GRADLE_PLUGIN_MODULE),
    description: String = getString(NEW_GRADLE_PLUGIN_MODULE_DESC),
    ...
    override fun actionPerformed(e: AnActionEvent) {
        ...
        val pair = ModuleTemplateHelper.gradlePluginTemplate() ?: return
